...
import { HiChevronUp, HiOutlineDocumentAdd } from 'react-icons/hi';
import { AiOutlineTwitter } from 'react-icons/ai';
import type { GeneratedIdea, TweetDraft, Tweet } from '@wasp/entities';
        ...
        <Disclosure>
          {({ open }) => (
            <>
              ...
              <Disclosure.Panel className=' pt-3 flex flex-row justify-end gap-0'>
                <Tippy content='Edit Idea & Add To Notes'>
                  <button
